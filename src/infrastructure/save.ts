...
export const CONTENT_HASH=checksum(JSON.stringify({content,mortalContent}));
...
export function parseSave(raw:unknown){
 ...
 if(e.contentHash!==CONTENT_HASH)throw new Error('内容版本不兼容，原存档已保留');
...
export class SaveRepository{
 ...
 async save(world:World,ui:UiSaveState={tab:'board'}){
